const { GENERIC_ERROR, VERIFY_EMAIL, USER_FEEDBACK, USER_INVITE, REPORT_SOMETHING, FORM2_SUBMISSION_TO_DEFRA, FORM2_CONFIRMATION_TO_POLICE, EMAIL_APPLICATION_PACK, POST_APPLICATION_PACK } = require('../../../constants/notification-types')
